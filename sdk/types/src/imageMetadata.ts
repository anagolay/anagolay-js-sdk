...
// https://gitlab.com/sensio_group/network-js-sdk/-/issues/68
...
export default interface ExpandedTags {
  file?: FileTags
  pngFile?: PngFileTags
  exif?: Tags
  iptc?: Tags
...
//   data: ArrayBuffer | SharedArrayBuffer | Buffer
// ): Tags & XmpTags & IccTags
...
interface Tags {
  ...
  BodySerialNumber: StringArrayTag
