...
declare module '@polkadot/api-base/types/submittable' {
  export interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    operations: {
       ...
       **/
      create: AugmentedSubmittable<(operationData: OperationData | { name?: any; description?: any; inputs?: any; config?: any; groups?: any; output?: any; repository?: any; license?: any; nostd?: any } | string | Uint8Array, versionData: OperationVersionData | { entityId?: any; parentId?: any; artifacts?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [OperationData, OperationVersionData]>;
      /**
       ...
       **/
      versionApprove: AugmentedSubmittable<(operationId: OperationId | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [OperationId]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    poe: {
       ...
       * `DispatchResultWithPostInfo` containing Unit type
       **/
      createProof: AugmentedSubmittable<(proofData: ProofData | { workflowId?: any; prevId?: any; creator?: any; groups?: any; params?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [ProofData]>;
      /**
       ...
       * `DispatchResultWithPostInfo` containing Unit type
       **/
      savePhash: AugmentedSubmittable<(phashInfo: PhashInfo | { pHash?: any; proofId?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [PhashInfo]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    statements: {
       ...
       * `DispatchResultWithPostInfo` containing Unit type
       **/
      createCopyright: AugmentedSubmittable<(statementData: StatementData | { signatures?: any; claim?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [StatementData]>;
      /**
       * Create Ownership.
       * 
       ...
       * `DispatchResultWithPostInfo` containing Unit type
       **/
      createOwnership: AugmentedSubmittable<(statementData: StatementData | { signatures?: any; claim?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [StatementData]>;
      /**
       ...
       * `DispatchResultWithPostInfo` containing Unit type
       **/
      revoke: AugmentedSubmittable<(statementId: StatementId | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [StatementId]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    workflows: {
       ...
       * `DispatchResultWithPostInfo` containing Unit type
       **/
      create: AugmentedSubmittable<(workflowData: WorkflowData | { name?: any; creators?: any; description?: any; groups?: any; segments?: any } | string | Uint8Array, versionData: WorkflowVersionData | { entityId?: any; parentId?: any; artifacts?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [WorkflowData, WorkflowVersionData]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
