...
import { PhashInfo, Proof } from './poe';
import { Rule } from './rules';
import { SensioStatement } from './statements';
import { Extrinsic } from '@polkadot/types/interfaces/extrinsics';
import { GrandpaEquivocationProof, KeyOwnerProof } from '@polkadot/types/interfaces/grandpa';
import { AccountId, AccountIndex, Address, Balance, Call, ChangesTrieConfiguration, KeyValue, LookupSource, Moment, Perbill, Weight } from '@polkadot/types/interfaces/runtime';
...
declare module '@polkadot/api/types/submittable' {
  export interface AugmentedSubmittables<ApiType> {
    ...
    operations: {
       ...
       * Create Operation
       **/
      create: AugmentedSubmittable<(data: Operation | { id?: any; data?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    poe: {
      [index: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
       ...
       **/
      createProof: AugmentedSubmittable<(proof: Proof | { id?: any; data?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       ...
       **/
      savePhash: AugmentedSubmittable<(payloadData: PhashInfo | { pHash?: any; proofId?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    rules: {
      [index: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
       * Create Rule
       **/
      createRule: AugmentedSubmittable<(rule: Rule | { id?: any; data?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    sensio: {
      [index: string]: SubmittableExtrinsicFunction<ApiType>;
      foo: AugmentedSubmittable<(something: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    statements: {
      [index: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
       * Create Copyright
       **/
      createCopyright: AugmentedSubmittable<(statement: SensioStatement | { id?: any; data?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
      /**
       * Create Ownership
       **/
      createOwnership: AugmentedSubmittable<(statement: SensioStatement | { id?: any; data?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>>;
    };
    sudo: {
      [index: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
