...
declare module '@polkadot/api/types/submittable' {
  export interface AugmentedSubmittables<ApiType> {
    anagolay: {
      ...
      foo: AugmentedSubmittable<(something: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u32]>;
    };
    balances: {
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
    ...
    poe: {
       ...
       **/
      savePhash: AugmentedSubmittable<(payloadData: PhashInfo | { pHash?: any; proofId?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [PhashInfo]>;
    };
    rules: {
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
      /**
