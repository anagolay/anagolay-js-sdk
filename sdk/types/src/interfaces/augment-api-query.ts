...
import { PhashInfo, ProofInfo, RuleInfo } from './poe';
import { GenericId } from './sensio';
import { StatementInfo } from './statements';
...
declare module '@polkadot/api/types/storage' {
  export interface AugmentedQueries<ApiType> {
    ...
    operations: {
       ...
       * Operations
       **/
      operations: AugmentedQuery<ApiType, (arg: GenericId | string | Uint8Array) => Observable<OperationInfo>> & QueryableStorageEntry<ApiType>;
    };
    poe: {
      [index: string]: QueryableStorageEntry<ApiType>;
      /**
       ...
       **/
      pHashes: AugmentedQuery<ApiType, (arg: Hash | string | Uint8Array) => Observable<PhashInfo>> & QueryableStorageEntry<ApiType>;
      /**
       * PoE Proofs
       **/
      proofs: AugmentedQuery<ApiType, (arg: GenericId | string | Uint8Array) => Observable<ProofInfo>> & QueryableStorageEntry<ApiType>;
      /**
       * Proofs count
       **/
    ...
    rules: {
       ...
       * Rules
       **/
      rules: AugmentedQuery<ApiType, (arg: GenericId | string | Uint8Array) => Observable<RuleInfo>> & QueryableStorageEntry<ApiType>;
    };
    sensio: {
      [index: string]: QueryableStorageEntry<ApiType>;
    ...
    statements: {
      [index: string]: QueryableStorageEntry<ApiType>;
      /**
       * The set of ALL Copyrights
       **/
      copyrights: AugmentedQuery<ApiType, () => Observable<Vec<GenericId>>> & QueryableStorageEntry<ApiType>;
      /**
       * Amount of saved Copyrights
       **/
      copyrightsCount: AugmentedQuery<ApiType, () => Observable<u128>> & QueryableStorageEntry<ApiType>;
      /**
       * How many copyright statements user has
       **/
      countUserCopyrightStatements: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<u128>> & QueryableStorageEntry<ApiType>;
      /**
       * How many ownership statements user has
       **/
      countUserOwnershipStatements: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<u128>> & QueryableStorageEntry<ApiType>;
      /**
       * How many statements user has
       **/
      countUserStatements: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<u128>> & QueryableStorageEntry<ApiType>;
      /**
       * Ownerships @TODO this doesn't have to contain all the info, what about only ids of the ownerships
       **/
      ownerships: AugmentedQuery<ApiType, () => Observable<Vec<GenericId>>> & QueryableStorageEntry<ApiType>;
      /**
       * Amount of saved Ownerships
       **/
      ownershipsCount: AugmentedQuery<ApiType, () => Observable<u128>> & QueryableStorageEntry<ApiType>;
      /**
       * ALL statements
       **/
      statements: AugmentedQuery<ApiType, (arg: GenericId | string | Uint8Array) => Observable<StatementInfo>> & QueryableStorageEntry<ApiType>;
      /**
       * Amount of saved Copyrights
       **/
       ...
       * User statements
       **/
      userStatements: AugmentedQuery<ApiType, (arg: AccountId | string | Uint8Array) => Observable<Vec<GenericId>>> & QueryableStorageEntry<ApiType>;
    };
    sudo: {
      [index: string]: QueryableStorageEntry<ApiType>;
      /**
