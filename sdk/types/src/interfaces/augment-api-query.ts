...
declare module '@polkadot/api/types/storage' {
  export interface AugmentedQueries<ApiType> {
    ...
    poe: {
       ...
       **/
      pHashes: AugmentedQueryDoubleMap<ApiType, (key1: Hash | string | Uint8Array, key2: AccountId | string | Uint8Array) => Observable<PhashInfo>, [Hash, AccountId]> & QueryableStorageEntry<ApiType, [Hash, AccountId]>;
      /**
       * PoE Proofs
       **/
