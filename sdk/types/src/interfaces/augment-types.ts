...
import type { AnagolayVersionExtra, ArtifactId, Characters, CreatorId, ForWhat, GenericId, OperationId, ProofId, SignatureId, StatementId, VersionId, WasmArtifactSubType, WorkflowId } from '@anagolay/types/interfaces/anagolaySupport';
import type { Operation, OperationArtifactStructure, OperationArtifactType, OperationData, OperationExtra, OperationRecord, OperationVersion, OperationVersionData, OperationVersionRecord, TypeName } from '@anagolay/types/interfaces/operations';
import type { PhashInfo, Proof, ProofData, ProofExtra, ProofParams, ProofRecord } from '@anagolay/types/interfaces/poe';
import type { Claim, ClaimType, Expiration, ExpirationType, Proportion, Signatures, StatementData, StatementExtra, StatementRecord, Validity } from '@anagolay/types/interfaces/statements';
import type { OperationVersionReference, Workflow, WorkflowArtifactStructure, WorkflowArtifactType, WorkflowData, WorkflowExtra, WorkflowRecord, WorkflowSegment, WorkflowVersion, WorkflowVersionData, WorkflowVersionRecord } from '@anagolay/types/interfaces/workflows';
