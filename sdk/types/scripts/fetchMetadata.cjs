...
// taken from https://github.com/KILTprotocol/sdk-js/blob/develop/packages/augment-api/scripts/fetchMetadata.js
// love what you do !!
...
switch (true) {
  ...
  case argv.endpoint.startsWith('ws'):
    ...
    break;
  default:
    throw new Error(`Can only handle ws/wss and http/https endpoints, received "${argv.endpoint}"`);
}
