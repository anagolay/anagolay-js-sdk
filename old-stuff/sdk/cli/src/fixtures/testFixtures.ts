...
export const defaultCreator = 'did:substrate:5HnKtosumdYfHSifYKBHhNmoXvhDANCU8j8v7tc4p4pY7MMP/sensio-network';

// anagolay network kusama account
export const defaultIssuer = 'did:substrate:5HBr9dSKkTjWr5XL7ZHGjQLgxf1ndfin7ERnJd1hN2P7xjTx/sensio-network';
                        ...
                        [
                          [
                            ...
                            [
                              ...
                              [
                                'identity',
                                [['take_photo_and_upload_qrcode', [['create_qrcode', [['cid', []]]]]]],
                              ],
                            ],
                          ],
                        ],
