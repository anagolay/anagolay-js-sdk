 ...
 * @return  output (Returns the raw pixel bytes without metadata`) and decoder function
 */
export async function imageRawPixels(params: InputParams): Promise<ReturnParams> {
...
// import { executeOperation, isBrowser } from '@anagolay/core'
// import { AnOperation } from '@anagolay/types'
// import config from './config'
// import { InputParams, ReturnParams } from './interfaces'
// /**
...
//   if (isBrowser) {
//     console.log('imageRawPixels executing in the browser')
...
//   } else {
//     console.log('imageRawPixels executing in the nodejs')
