...
import execute, { snCreateQrcode } from '.'
...
describe('SnOperation: snCreateQrcode', (): void => {
  ...
  it('should execute default op', async (): Promise<void> => {
  ...
  it('should execute snCreateQrcode op', async (): Promise<void> => {
    const data = await snCreateQrcode([
      {
        data: stringToU8a(demoData.data),
        decode: () => demoData.data,
      },
